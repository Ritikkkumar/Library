...
const nonfictionSlice=createSlice({
    name:"nonfiction",
    initialState:{
        books:[
            {
    ...
    reducers:{
      addNonFictionItem:(state,action)=>{
        state.books.unshift(action.payload);
      },
    }
})

export const{addNonFictionItem}=nonfictionSlice.actions;
export default nonfictionSlice.reducer;